...
entry="node lib/jasmine-node/cli.js --noStackTrace "

echo "Running all tests located in the spec directory"
command=$entry"spec"
echo $command
time $command #/nested/uber-nested
echo -e "\033[1;35m--- Should have 31 tests, 1 Failure and 2 Skipped. ---\033[0m"
echo ""
...
echo $command
time $command #/nested/uber-nested
echo -e "\033[1;35m--- Should have 34 tests, 1 Failure and 2 Skipped. ---\033[0m"
echo ""
