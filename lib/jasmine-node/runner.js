(function() {
  ...
  minimistOpts = {
    boolean: ["autoTest", "captureExceptions", "coffee", "debug", "growl", "h", "help", "junit", "matchAll", "noColor", "noStackTrace", "verbose", "version"],
    string: ["junitConfig", "m", "match", "watchFolders"],
    alias: {
      match: "m",
      help: "h"
    },
  ...
  parseArgs = function() {
    var allowed, key, options, secretOptions, spec, _i, _len, _ref;
    ...
    if (options.junitConfig !== '') {
      if (!fs.existsSync(options.junitConfig)) {
