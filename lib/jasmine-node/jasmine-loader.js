(function() {
  var booter, contextObj, executeSpecsInFolder, fileFinder, fs, loadHelpersInFolder, loadJasmine, mkdirp, path, print, removeJasmineFrames, util, vm, _;
  ...
  loadJasmine = function() {
    var clockCallback, context, jasmineEnv, jasmineSrc, jasminejs;
