(function() {
  ...
  loadHelpersInFolder = function(folder, matcher) {
    var e, file, folderStats, help, helper, helperItem, helperNames, helpers, key, matchedHelpers, _i, _len;
  ...
  executeSpecsInFolder = function(options) {
    var defaults, error, jasmine, jasmineEnv, matchedSpecs, reporterOptions, spec, specPath, specsList, _i, _len;
