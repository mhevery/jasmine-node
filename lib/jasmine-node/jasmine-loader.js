(function() {
  var bootSrc, bootjs, fs, growlReporter, helperCollection, isWindowDefined, jasmine, jasmineSrc, jasminejs, key, mkdirp, nodeReporters, path, print, removeJasmineFrames, specs, util, value, vm, _;
