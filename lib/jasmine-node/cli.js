...
while(args.length) {
  ...
  switch(arg)
  {
    ...
    case '--seed':
        randomize = true;
        randomSeed = parseInt( args.shift(), 10 );
        break;
    case '--junitreport':
...
function help(){
  ...
  , '  --randomize        - shuffle the list of spec files before running'
  , '  --seed SEED        - shuffle the list of spec files using the supplied seed'
