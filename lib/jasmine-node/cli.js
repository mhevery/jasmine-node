(function() {
  var args, coffee, dir, error, exitCode, fs, help, helperCollection, jasmine, key, matcher, minimist, minimistOpts, onExit, options, path, printVersion, spec, specFolder, util, value, _, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4;
  ...
  minimistOpts = {
    boolean: ["autoTest", "captureExceptions", "coffee", "forceExit", "matchAll", "noColor", "noStackTrace", "verbose"],
    alias: {
      m: "match"
    },
    "default": {
  ...
  if ((args.m != null) || (args.match != null)) {
    options.match = (_ref = args.m) != null ? _ref : args.match;
  }
