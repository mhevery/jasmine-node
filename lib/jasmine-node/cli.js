(function() {
  var allowed, args, autoTest, coffee, dir, error, exitCode, fs, growl, help, jasmine, key, matcher, minimist, minimistOpts, onExit, options, path, printVersion, spec, specFolder, util, value, _, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3,
  ...
  onExit = function() {
    ...
    if ((_ref3 = global.jasmineResult) != null ? _ref3.fail : void 0) {
      exitCode = 1;
    }
    process.exit(exitCode);
  };
