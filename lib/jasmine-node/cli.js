(function() {
  var allowed, args, coffee, dir, error, exitCode, fs, help, jasmine, key, matcher, minimist, minimistOpts, onExit, options, path, printVersion, spec, specFolder, util, value, _, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3,
  ...
  minimistOpts = {
    boolean: ["autoTest", "captureExceptions", "coffee", "forceExit", "h", "help", "matchAll", "noColor", "noStackTrace", "verbose"],
